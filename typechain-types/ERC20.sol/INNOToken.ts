...
export interface INNOTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface INNOToken extends BaseContract {
  connect(runner?: ContractRunner | null): INNOToken;
  waitForDeployment(): Promise<this>;

  interface: INNOTokenInterface;
